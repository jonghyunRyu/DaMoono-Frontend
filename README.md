...
|<img width="483" height="816" alt="image" src="https://github.com/user-attachments/assets/2d6c6c1a-5990-45b4-8d2b-ccc3b952ddd2" />
 | **2. 🧠 AI 챗봇 (텍스트 / 음성)**<br><br>• OpenAI 기반 챗봇과 대화하며 요금제 추천 제공<br>• LangChain Conversation Chain 기반 대화 흐름 설계<br>• 의도 분석 → 프롬프트 생성 → 요금제 후보 도출 → 카드형 응답 렌더링 구조<br>• 텍스트 입력 / Web Speech API 기반 음성 입력 모두 지원<br>• 성향 테스트 결과를 프롬프트 컨텍스트에 포함해 추천 정확도 향상<br>• 정확 모드 / 자연 모드 전환 가능<br>• 챗봇 이탈 후 재접속 시 대화 히스토리 유지 |
...
| <img width="100" height="100" alt="류종현" src="https://github.com/user-attachments/assets/06bb752e-50a2-4c22-b20d-bae6a353058a" /> | **류종현**<br/>[@jonghyunRyu](https://github.com/jonghyunRyu) | **Frontend**<br/>마이페이지 및 관리자 페이지 UI 구현, 상담 이력·이용 데이터 시각화, 요금제·구독 정보 조회 UI 개발, 다중 데이터 로딩 렌더링 최적화 및 3D 로딩 UI 적용 |
...
| <img width="100" height="100" alt="image" src="https://github.com/user-attachments/assets/e86db225-ed66-4693-989b-f9aed7fa5d08" /> | **이해니**<br/>[@haeni82](https://github.com/haeni82) | **Frontend**<br/>상담 요약 페이지(UI) 구현, 유저용 상담 요약 프롬프트(JSON) 설계, 상담사 WebSocket 양방향 통신 구조 설계, 상담 요약 및 후속 액션 제안 기능 기획 |
| <img width="100" height="100" alt="이혁준" src="https://github.com/user-attachments/assets/04ac3d3a-fae1-4bf7-95de-f8efcf6374d2" /> | **이혁준**<br/>[@Lilium0422](https://github.com/Lilium0422) | **Frontend**<br/>홈·온보딩·성향 분석 페이지 UI 및 컴포넌트 구현, 사용자 성향 분석 로직 설계, 공용 레이아웃(헤더·하단 메뉴) 및 서비스 가이드 UI 개발 |
| <img width="100" height="100" alt="유덕현" src="https://github.com/user-attachments/assets/f220a58f-7388-4cc2-ac11-d1d82f052084" /> | **유덕현**<br/>[@Ydh0622](https://github.com/Ydh0622) | **Frontend**<br/>FAQ 페이지 및 군인·미성년자·대리인 가입 시 구비 서류 안내 UI 구현, 이미지 애니메이션 및 인터랙션 마무리 |
| <img width="100" height="100" alt="최낙운" src="https://github.com/user-attachments/assets/300343ef-7c90-4843-802a-924b8f029f87" /> | **최낙운**<br/>[@skrdnss-byte](https://github.com/skrdnss-byte) | **Frontend**<br/> 구독·요금제 서비스 UI 및 컴포넌트 구현, 백엔드 API 연동, 데이터 분석차트 시각화 및 비교 기능 설계 구현, 로그인 상태 기반 동적 UI/UX 구현 ||
