...
|<img width="483" height="816" alt="image" src="https://github.com/user-attachments/assets/2d6c6c1a-5990-45b4-8d2b-ccc3b952ddd2" />| **2. 🧠 AI 챗봇 (텍스트 / 음성)**<br><br>• OpenAI 기반 챗봇과 대화하며 요금제 추천 제공<br>• LangChain Conversation Chain 기반 대화 흐름 설계<br>• 의도 분석 → 프롬프트 생성 → 요금제 후보 도출 → 카드형 응답 렌더링 구조<br>• 텍스트 입력 / Web Speech API 기반 음성 입력 모두 지원<br>• 성향 테스트 결과를 프롬프트 컨텍스트에 포함해 추천 정확도 향상<br>• 정확 모드 / 자연 모드 전환 가능<br>• 챗봇 이탈 후 재접속 시 대화 히스토리 유지 |
